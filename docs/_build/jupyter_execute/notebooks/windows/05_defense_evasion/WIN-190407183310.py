...
| Category | Type | Name     |
| :--------| :----| :--------|
| signature | SIGMA | [sysmon_rdp_registry_modification](https://github.com/OTRF/ThreatHunter-Playbook/tree/master/signatures/sigma/sysmon_rdp_registry_modification.yml) |
